...
const LeftSide = ({ className = 'w-full' }) => {
                        ...
                        <div className="flex flex-col">
                            <div className="relative">
                                <div
                                    ...
                                    <Image src="/rami/team/ceo.svg" alt='-' width={300} height={200} priority />
                                    {/* Socials */}
                                    <div className="w-full flex justify-center items-center space-x-2">
                                        ...
                                        <Link target='_blank' href="https://x.com/mg_ramicoin" className='w-7 h-7 bg-[#000000] rounded-sm flex justify-center items-center transition-all duration-300 transform hover:scale-110 hover:bg-orange-500'>
